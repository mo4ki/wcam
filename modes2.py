...
if ass == "0":
	...
	os.system("clear")
	os.system("sudo apt install pkg-config libnl-3-dev libnl-genl-3-dev libpcap-dev")
	os.system("git clone https://github.com/aircrack-ng/mdk4")
	os.system("cd mdk4")
	os.system("sudo make")
	os.system("sudo make install")
	os.system("cd ..")
	os.system("sudo rm mdk4/ -rf")
	os.system("clear")
...
[10] Выход: Просто выход. (ШВ - 0)
	...
	sleep(3)
	print("И сказал я что хотел так python изучить, а он в ответ то, что подобным образом учил.\n")
	sleep(3)
